...
<ul>
    <li>The raspberry theme contrast has been improved for better visibility.</li>
    <li>Select widget options are now sorted alphabetically for easier navigation.</li>
    <li>After adding an option in select widgets, it is now automatically selected.</li>
    <li>The company name is now displayed in job and person selects for better identification.</li>
    <li>An option for application on company websites has been added to the job modal.</li>
</ul>

<h5>Bug Fixes</h5>
<ul>
    <li>The source aggregator is now consistently shown when editing a job.</li>
    <li>The content of job application update and interview modals are now refreshed correctly after an edit when edited through the job modal.</li>
