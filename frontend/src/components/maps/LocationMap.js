...
const LocationMap = ({locations = [], height = '400px'}) => {
        ...
        return (<div style={{height}}
            ...
            <div className="text-center p-4">
                ...
                <p className="text-muted mb-0 small">
                    {locationsToGeocode.length === 0 ? "Add some non-remote locations to see them on the map." : "Could not find coordinates for any locations."}
                </p>
            </div>
        </div>);
    }
    ...
    return (<div>
        <div style={{
            height, borderRadius: '8px', overflow: 'hidden', boxShadow: '0 2px 8px rgba(0,0,0,0.1)'
        }}>
            <MapContainer
                center={getMapCenter()}
            ...
            >
                ...
                {geocodedLocations.map((location) => (<Marker
                    key={location.id}
                ...
                >
                    <Popup>
                        <div style={{minWidth: '180px'}}>
                            ...
                            {location.postcode && (<p className="mb-1">
