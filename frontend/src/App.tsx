...
const routeConfigs: RouteConfig[] = [
	...
	{ path: "/files/cv", element: <FilesPage />, protected: true },
	{ path: "/files/cover-letters", element: <FilesPage />, protected: true },
	{ path: "/files", element: <Navigate to="/files/cv" replace />, protected: true },
