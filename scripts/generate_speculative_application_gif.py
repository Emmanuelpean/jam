...
class SpeculativeApplicationRecorder(DemoRecorder):
    ...
    def create_demo_data(self, db, users) -> None:
        """Create companies and people for the demo"""

        create_geolocations(db)
        companies = create_companies(db, users)
        create_people(db, users, companies)

        print("  Created demo data with companies and people")
...
def main():
    ...
    parser.add_argument("--output", default="speculative_application_demo.gif", help="Output GIF path")
