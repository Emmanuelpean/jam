...
class TestUser:
    ...
    def test_update_user_admin(self, authorised_clients, test_users, session) -> None:
    ...
    def test_update_user_non_admin(self, authorised_clients, test_users, session) -> None:
