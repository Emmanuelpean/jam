...
def seed_database() -> None:
    ...
    try:
        ...
        scraped_job_filters = create_scraped_job_filters(db, users)
        scraped_jobs = create_scraped_jobs(db, alert_emails, users, scraped_job_filters)
        ...
        print(f"Job Filters: {len(scraped_job_filters)}")
