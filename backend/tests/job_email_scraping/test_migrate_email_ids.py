...
@pytest.fixture
def make_email(session, test_users, test_job_scraping_service_log) -> Callable[..., models.JobEmail]:
...
@pytest.fixture
def patch_dependencies(session, monkeypatch) -> Callable[[list[EmailData]], mock.MagicMock]:
...
class TestRunMigration:
    ...
    def test_dry_run_leaves_database_unchanged(self, make_email, patch_dependencies) -> None:
    ...
    def test_apply_updates_external_email_id_to_uid(self, make_email, patch_dependencies) -> None:
        email = make_email("100", "LinkedIn alert A", BASE_DATE)
        patch_dependencies([_vps_email("5", "LinkedIn alert A", BASE_DATE)])
    ...
    def test_apply_updates_multiple_records(self, make_email, patch_dependencies) -> None:
    ...
    def test_jam_prefixed_records_are_ignored(self, make_email, patch_dependencies) -> None:
    ...
    def test_raises_when_no_match_found(self, make_email, patch_dependencies) -> None:
    ...
    def test_raises_when_multiple_matches_found(self, make_email, patch_dependencies) -> None:
        make_email("100", "LinkedIn alert A", BASE_DATE)
        patch_dependencies(
            [
                _vps_email("5", "LinkedIn alert A", BASE_DATE),
    ...
    def test_match_requires_both_subject_and_date(self, make_email, patch_dependencies) -> None:
