...
job_expected = [{'company': 'Thermulon',
                 'location': 'London',
                ...
                {'company': 'Seagate Technology',
                 'location': 'Derry',
                 'job': {'title': 'Graduate Photonic Scientist',
                ...
                {'company': 'PepsiCo',
                 'location': 'Leicester',
                 'job': {'title': 'R&D Senior Engineer (Process Development Function)',
                ...
                {'company': 'Pharmaron',
                 'location': 'Hoddesdon',
                 'job': {'title': 'Senior Process Development Engineer, Process Chemistry',
                ...
                {'company': 'G&H',
                 'location': 'Ilminster',
                 'job': {'title': 'Market Applications Engineer',
                ...
                {'company': 'Raytec Ltd',
                 'location': 'Ashington',
                 'job': {'title': 'Regulatory Compliance Engineer',
                ...
                {'company': 'Bactobio',
                 'location': 'London',
                 'job': {'title': 'Technical Senior Scientist',
                ...
                {'company': 'Panasonic Manufacturing',
                 'location': 'Cardiff',
                 'job': {'title': 'Graduate Mechanical Design Engineer',
                ...
                {'company': 'Cambridge Audio',
                 'location': 'London',
                 'job': {'title': 'Acoustics & Product Development Intern (Paid Internship)',
                ...
                {'company': 'Aston Martin Lagonda Ltd',
                 'location': 'Gaydon',
                 'job': {'title': 'Manufacturing Senior Engineer',
                ...
                {'company': 'Spectralink',
                 'location': 'Bracknell',
                 'job': {'title': 'DECT Tier 2 Technical Support Engineer',
