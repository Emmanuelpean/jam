...
body_content = resources.INDEED_EMAIL_1_BODY
...
INDEED_JOB_EXPECTED = [
    ...
    },
    {
        ...
        "job": {
            ...
            "salary": {"min_amount": None, "max_amount": None, "currency": None},
        },
    ...
    },
    {
        ...
        "job": {
            ...
            "salary": {"min_amount": 30000.0, "max_amount": 40000.0, "currency": "GBP"},
        },
    ...
    },
    {
        ...
        "job": {
            ...
            "salary": {"min_amount": 55000.0, "max_amount": 68000.0, "currency": "GBP"},
        },
    ...
    },
    {
        ...
        "job": {
            ...
            "salary": {"min_amount": 34000.0, "max_amount": 42000.0, "currency": "GBP"},
        },
    ...
    },
    {
        ...
        "job": {
            ...
            "salary": {"min_amount": 40000.0, "max_amount": 50000.0, "currency": "GBP"},
        },
    ...
    },
    {
        ...
        "job": {
            ...
            "salary": {"min_amount": 45000.0, "max_amount": 55000.0, "currency": "GBP"},
        },
...
def test_extract_indeed_jobs_from_email() -> None:
    """Check that the correct number of job IDs are extracted from the email."""

    result = extract_indeed_jobs_from_email(body_content)
    assert result == [JobResult.model_validate(expected) for expected in INDEED_JOB_EXPECTED]
...
def test_parse_indeed_job_section(job_section, expected) -> None:
    """Check that the parsed job section matches the expected data
    :param job_section: The job section to test
    :param expected: The expected job section data"""

    result = parse_indeed_job_section(job_section)
    assert result == JobResult.model_validate(expected)
