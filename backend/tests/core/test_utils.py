...
class TestGenerateToken:
    ...
    def test_generate_token(self, test_regular_user: FixtureUser, session: Session) -> None:
...
class TestCheckTokenRateLimit:
    ...
    @staticmethod
    def _add_token(session: Session, user_id: int, token_type: TokenType, minutes_ago: int) -> models.UserToken:
    ...
    def test_no_existing_token(self, test_regular_user: FixtureUser, session: Session) -> None:
    ...
    def test_existing_token(
        self, test_regular_user: FixtureUser, session: Session, minutes_ago: int, expected_remaining: int
    ) -> None:
    ...
    def test_ignores_other_token_types(self, test_regular_user: FixtureUser, session: Session) -> None:
    ...
    def test_ignores_other_users_tokens(
        ...
        self._add_token(session, test_admin_user.id, TokenType.EMAIL_VERIFICATION, 0)
...
class TestSendVerificationWithRateLimit:
    ...
    def test_send_rate_limited_tokenized_email(self, test_regular_user: FixtureUser, session: Session) -> None:
    ...
    def test_send_rate_limited_tokenized_email_rate_limited(
...
class TestSendEmailVerificationEmailWithRateLimit:
    ...
    def test_send_rate_limited_tokenized_email_verification_email(
        self, mock_verification_email: Mock, test_regular_user: FixtureUser, session: Session
    ) -> None:
        """Test sending of verification email."""
...
class TestSendPasswordResetWithRateLimit:
    ...
    def test_send_rate_limited_tokenized_password_reset_email(
        self, mock_password_reset_email: Mock, test_regular_user: FixtureUser, session: Session
    ) -> None:
...
class TestSendEmailChangeWithRateLimit:
    ...
    def test_send_rate_limited_tokenized_email_change_email(
        self, mock_email_verif: Mock, test_regular_user: FixtureUser, session: Session
    ) -> None:
        """Test sending of email change verification email."""

        result = send_rate_limited_tokenized_email_change_email(test_regular_user, "newemail@test.com", session)
    ...
    def test_send_rate_limited_tokenized_email_change_email_rate_limited(
        self, mock_email_verif: Mock, test_regular_user: FixtureUser, session: Session
    ) -> None:
        """Test rate limiting when sending email change verification email."""

        send_rate_limited_tokenized_email_change_email(test_regular_user, "newemail@test.com", session)
        result = send_rate_limited_tokenized_email_change_email(test_regular_user, "newemail2@test.com", session)
...
class TestSendPasswordChangedWithRateLimit:
    ...
    def test_send_tokenized_password_changed_email_with_rate_limit(
        self, mock_password_changed_email: Mock, test_regular_user: FixtureUser, session: Session
    ) -> None:
