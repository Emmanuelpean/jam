"""HTTP-level tests for the provider-monitoring service-log router.

Covers the service-log router (`/service-logs/provider_monitoring_service/*`): date-range query and
...
@pytest.fixture
def seeded_service_logs(session) -> list[models.ProviderMonitoringServiceLog]:
    ...
    rows = [
        models.ProviderMonitoringServiceLog(
...
class TestServiceLogsByDateRange:
    endpoint = "/service-logs/provider_monitoring_service/"
...
class TestServiceLogsLatest:
    endpoint = "/service-logs/provider_monitoring_service/latest"
