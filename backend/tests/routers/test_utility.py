...
class TestParseColumnFiltersEdgeCases:
    ...
    def test_unknown_filter_type_produces_no_condition(self) -> None:
...
class TestParseColumnFiltersText:
    ...
    def test_produces_ilike_condition(self) -> None:
...
class TestParseColumnFiltersSelect:
    ...
    def test_produces_in_condition(self) -> None:
...
class TestParseColumnFiltersNumber:
    ...
    def test_null_filter_not_null_with_range_produces_three_conditions(self) -> None:
        filters = json.dumps({"job_found_n": {"type": "number", "min": 5, "max": 20, "nullFilter": "not_null"}})
        conditions, _ = parse_column_filters(filters, models.JobEmail)
        # IS NOT NULL + >= 5 + <= 20
        assert len(conditions) == 3

    def test_null_filter_all_with_range_skips_null_check(self) -> None:
...
class TestParseColumnFiltersReference:
    ...
    def test_produces_in_condition_with_int_values(self) -> None:
...
class TestParseColumnFiltersPrefixedModels:
    ...
    def test_prefixed_column_resolves_and_adds_model_to_join_set(self) -> None:
    ...
    def test_primary_model_column_does_not_trigger_join(self) -> None:
    ...
    def test_multiple_prefixed_keys_add_model_to_join_set_once(self) -> None:
        filters = json.dumps(
            {
    ...
    def test_omitting_prefixed_models_treats_dotted_key_as_unknown(self) -> None:
        filters = json.dumps({"job_rating.overall_score": {"type": "number", "min": 5, "max": None}})
...
class TestParseColumnFiltersMultiple:
    ...
    def test_multiple_filters_each_produce_a_condition(self) -> None:
        filters = json.dumps(
            {
    ...
    def test_mix_of_valid_and_invalid_keys(self) -> None:
        filters = json.dumps(
            {
                "subject": {"type": "text", "value": "python"},
