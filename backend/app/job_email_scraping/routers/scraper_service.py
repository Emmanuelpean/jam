...
from app.job_email_scraping.email_scraper import job_scraping_service_runner
from app.service_runner import routers
from job_email_scraping.email_scraper import JobEmailScrapingService
...
def get_scraper_logs(
    ...
    return routers.get_service_logs(JobEmailScrapingService.service_name, lines, current_user)
