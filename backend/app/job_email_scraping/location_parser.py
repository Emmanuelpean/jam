...
class LocationParser:
    """Parser for extracting attendance type from job location strings"""
    ...
    def remove_attendance_indicators(self, location_str: str) -> str:
        ...
        all_indicators = []
        for indicators in self.attendance_indicators.values():
    ...
    def parse_location(self, location_str: str) -> tuple[str, str | None]:
        ...
        cleaned_location = self.remove_attendance_indicators(location_str)
