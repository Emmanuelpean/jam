...
from app.external_service_monitoring.brightdata.schemas import BrightdataBalanceOut, BrightdataDailyUsageOut
from app.routers.utility import assert_admin, filter_by_date


@external_service_monitoring_history_router.get("/brightdata", response_model=list[BrightdataDailyUsageOut])
...
@external_service_monitoring_history_router.get("/brightdata/balance", response_model=BrightdataBalanceOut | None)
