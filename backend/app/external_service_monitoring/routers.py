...
from app.external_service_monitoring.service.routers import (  # noqa: F401
    external_service_monitoring_service_router,
    external_service_monitoring_service_log_router,
)
