...
from app.provider_monitoring.apify.schemas import ApifyBalanceOut
from app.provider_monitoring.apify.schemas import ApifyDailyUsageOut
from app.routers.utility import assert_admin, filter_by_date


@provider_monitoring_history_router.get("/apify", response_model=list[ApifyDailyUsageOut])
...
@provider_monitoring_history_router.get("/apify/balance", response_model=ApifyBalanceOut | None)
